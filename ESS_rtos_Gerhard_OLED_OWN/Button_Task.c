...
/**
*
* \brief ISR fuer Button 1: Umschalten des Display_Mode
*
*/
...
/**
*
* \brief ISR fuer Button 2: Ausschalten der Sensor-Messungen
*
*/
...
/**
*
* \brief Clock-Task f�r Tasten entprellen,
...
/**
*
* \brief Initalisierung fuer die beiden Button
*
* \param Shared_Data: shared memory in dem in Abhaengigkeit der gedruckten Buttons
